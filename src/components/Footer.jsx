...
export default function Footer() {
  return (
    <div className='w-full h-screen  px-20 py-20 flex gap-5'>
        <div className='w-1/2 h-full flex flex-col justify-between'>
            <div>
                <h1 className='text-[6vw] leading-none -mb-5 text-black font-bold'>EYE-</h1>
                <h1 className='text-[6vw] leading-none -mb-5 text-black font-bold'>OPNING</h1>
            </div>
        ...
        <div className='w-1/2 h-full'>
            <h1 className='text-[6vw] font-bold text-black'>PRESENTATIONS</h1>
            <div className='py-10 w-full h-1/3'>
                <h1>S:</h1><br />
                <a className='underline-offset-1' href="">instagram</a><br />
                <a className='underline-offset-1' href="">Behance</a><br />
                <a className='underline-offset-1' href="">Facebook</a><br />
                <a className='underline-offset-1' href="">LinkedIn</a>

            </div>
            <div className='pt-20 w-full h-1/2 flex justify-between'>
                <div>
                    <h1>S:</h1><br />
                    <a className='underline-offset-1' href="">instagram</a><br />
                    <a className='underline-offset-1' href="">Behance</a><br />
                ...
                <div>
                <h1>S:</h1><br />
                    <a className='block underline-offset-1' href="">instagram</a>
                    <a className='block underline-offset-1' href="">Behance</a>
                    <a className='block underline-offset-1' href="">Facebook</a>
                    <a className='block underline-offset-1' href="">LinkedIn</a>
                </div>
            </div>
